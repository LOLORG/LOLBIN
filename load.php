...
return hljs;
}));</script><script>hljs.initHighlightingOnLoad();</script></head><body><a href="?delete=1"><button id=del-btn>DEL</button></a><pre id=container><code><?php echo $paste ?></code></pre></body></html>