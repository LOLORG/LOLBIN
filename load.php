...
</script></head><body><a href="?delete=1"><button id="del-btn">DEL</button></a><pre id="container"><code id="paste">Decrypting&hellip;</code></pre><script>document.getElementById("paste").innerText=JSON.parse(CryptoJS.AES.decrypt('<?php echo $paste ?>', window.location.href.split("#", 2)[1], {format: CryptoJSAesJson}).toString(CryptoJS.enc.Utf8));</script></body></html>